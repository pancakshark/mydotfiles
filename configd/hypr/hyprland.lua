-- Config cleaned up to use $HOME instead of hardcoded usernames
...
hl.env("XCURSOR_THEME", "Banana-Cursor")
hl.env("HYPRCURSOR_SIZE", "24")
hl.env("HYPRCURSOR_THEME", "Banana-Cursor")
...
hl.bind(mainMod .. " + SHIFT + R",
        hl.dsp.exec_cmd(scripts .. "/wbrestart.sh"))

hl.bind(mainMod .. " + L",
        hl.dsp.exec_cmd(scripts .. "/hyprlock.sh"))

hl.bind(mainMod .. " + SHIFT + S",
        hl.dsp.exec_cmd("quickshell -c HyprQuickFrame -n"))

hl.bind(mainMod .. " + W",
        hl.dsp.exec_cmd("bash " .. scripts .. "/wppicker.sh"))

hl.bind(mainMod .. " + SHIFT + X",
        hl.dsp.exec_cmd(scripts .. "/KillActiveProcess.sh"))

hl.bind(mainMod .. " + SHIFT + C",
        hl.dsp.exec_cmd("hyprpicker -a"))

hl.bind(mainMod .. " + CTRL + B",
        hl.dsp.exec_cmd(scripts .. "/WaybarStyles.sh"))

hl.bind(mainMod .. " + ALT + B",
        hl.dsp.exec_cmd(scripts .. "/WaybarLayout.sh"))
...
for i = 1, 10 do
        ...
        hl.bind("XF86AudioMute",
                hl.dsp.exec_cmd(scripts .. "/volume.sh --toggle"),
                { locked = true })
        ...
        hl.bind("XF86MonBrightnessUp",
                hl.dsp.exec_cmd(scripts .. "/brightness.sh --inc"),
                { locked = true, repeating = true })
